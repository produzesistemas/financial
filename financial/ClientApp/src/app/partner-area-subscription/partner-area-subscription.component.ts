...
@Component({
  selector: 'app-partner-area-subscription',
  templateUrl: './partner-area-subscription.component.html'
})

export class PartnerAreaSubscriptionComponent implements OnInit {
