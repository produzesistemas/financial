...
@Component({
    selector: 'app-partner-area-change-password',
    templateUrl: './partner-area-change-password.component.html'
})

export class PartnerAreaChangePasswordComponent implements OnInit {
    form: any;
