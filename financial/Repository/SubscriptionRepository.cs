...
namespace Repositorys
{
    public class SubscriptionRepository : ISubscriptionRepository, IDisposable
    {
        ...
        {
            var entity = _context.Subscription.FirstOrDefault(x => x.Id == id);
        ...
        {
            return _context.Subscription.FirstOrDefault(x => x.Id == id);
        }
        ...
        {
            var entityBase = _context.Subscription.FirstOrDefault(x => x.Id == entity.Id);
