...
namespace Repositorys
{
    public class OpeningHoursRepository : IOpeningHoursRepository, IDisposable
    {
        ...
        {
            var entity = _context.OpeningHours.FirstOrDefault(x => x.Id == id);
        ...
        {
            return _context.OpeningHours.FirstOrDefault(x => x.Id == id);
        }
        ...
        {
            var entityBase = _context.OpeningHours.FirstOrDefault(x => x.Id == entity.Id);
